...
int WritePPM(const char *f, int mode, int width, int height, unsigned char *ptr ); // +alberto
//int WritePPM(char *f, int mode, int width, int height, unsigned char *ptr ); -alberto
